...
# MYRIA_ARG1="--port 4001" # You can define custom args here
EOF
...
echo ">>>[INFO] Installation completed for $SERVICE_NAME!"
echo ">>>[INFO] Use 'myria-node1 --help' for usage instructions."
